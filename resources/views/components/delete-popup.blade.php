<div class="fixed top-0 left-0 w-screen h-screen z-50 hidden" id="popup">
    <div class="w-full h-full px-2 sm:px-4 lg:px-32 xl:px-72 py-8 relative z-50 flex items-center justify-center">
        <div class="w-full px-8 py-12 bg-white dark:bg-slate-800 rounded-md">
            ...
            <div class="mt-4 flex">
                <a href="#"><button id="popup_action" class="py-2 px-4 text-white transition-colors duration-150 bg-purple-600 border border-transparent rounded-lg active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple">Continue</button></a>
                <button id="popup_cancel" class="py-2 px-4 bg-gray-400 hover:bg-gray-300 dark:bg-slate-700 dark:hover:bg-slate-600 mx-2 border border-transparent rounded-lg rounded-sm dark:text-white">Cancel</button>
            </div>
        </div>
    </div>

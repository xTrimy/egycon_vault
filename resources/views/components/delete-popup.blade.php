    ...
    <div class="w-full px-8 py-12 bg-white dark:bg-slate-800 rounded-md">
      ...
      <div class="mt-4 flex">
        ...
        <button id="popup_cancel"
          class="py-2 px-4 bg-gray-400 hover:bg-gray-300 dark:bg-slate-700 dark:hover:bg-slate-600 mx-2 border border-transparent rounded-lg rounded-sm dark:text-white">Cancel</button>
      </div>
    </div>
  </div>

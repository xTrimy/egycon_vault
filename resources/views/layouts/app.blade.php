    ...
    <div class="flex h-screen bg-gray-50 dark:bg-gray-900" :class="{ 'overflow-hidden': isSideMenuOpen }">
      ...
      <aside class="z-20 hidden w-64 overflow-y-auto bg-white dark:bg-gray-800 md:block flex-shrink-0">
        <div class="py-4 text-gray-500 dark:text-gray-400">
          <a class="ml-6 text-lg flex items-center font-bold text-gray-800 dark:text-gray-200"
            href="{{ route('home') }}">
          ...
          <ul>
            ...
            <li class="relative px-6 py-3">
              ...
              <a class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                href="{{ route('history') }}">
                <i class="las la-suitcase text-xl"></i>
                <span class="ml-4">Actions History</span>
              </a>
            </li>
            <li class="relative px-6 py-3">
              @if ($page == 'slots')
            ...
            <div class="flex justify-center flex-1 lg:mr-32">
              <div class="relative w-full max-w-xl mr-6 focus-within:text-purple-500">
                ...
                <div id="search_dropdown"
                  class="absolute top-full w-full py-2 bg-white dark:bg-gray-800 shadow-sm px-4">
                  ...
                  <div class="hidden" id="search_element_cloner">
                    <a
                      class="element block py-2 px-4 text-gray-500 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-600 cursor-pointer">
                      ...
                      if (this.readyState == 4 && this.status == 200) {
                        ...
                        if (persons) {
                          for (let i = 0; i < persons.length; i++) {
                            ...
                            element.innerHTML = persons[i].name.toLowerCase().replace(self.value.toLowerCase(),
                              `<span class='font-bold text-black dark:text-white'>${self.value}</span>`);
                        ...
                        if (emails) {
                          for (let i = 0; i < emails.length; i++) {
                            ...
                            element.innerHTML = emails[i].email.toLowerCase().replace(self.value.toLowerCase(),
                              `<span class='font-bold text-black dark:text-white'>${self.value}</span>`);
                        ...
                        if (phones) {
                          for (let i = 0; i < phones.length; i++) {
                            ...
                            element.innerHTML += " | " + phones[i].phone.replace(self.value,
                              `<span class='font-bold text-black dark:text-white'>${self.value}</span>`);
                        ...
                        if (codes) {
                          for (let i = 0; i < codes.length; i++) {
                            ...
                            element.innerHTML += " | " + codes[i].code.replace(self.value,
                              `<span class='font-bold text-black dark:text-white'>${self.value}</span>`);
            ...
            <ul class="flex items-center flex-shrink-0 space-x-6">
              ...
              <li class="relative">
                <button class="align-middle rounded-full focus:shadow-outline-purple focus:outline-none"
                  ...
                  aria-haspopup="true">
                  <img class="object-cover w-8 h-8 rounded-full border" aria-hidden="true" />
                </button>

  ...
  <div class="container grid px-6 mx-auto">
    ...
    <div class="w-full overflow-hidden rounded-lg shadow-xs">
      <div class="w-full overflow-x-auto bg-white dark:bg-gray-800 px-4 py-8">
        <div class="w-48 h-48 bg-black rounded-lg relative overflow-hidden">
          @if ($belonging->image)
          ...
          <img id="viewer-image"
            ...
            src="{{ asset('images/belongings/' . $belonging->image) }}" alt="" loading="lazy" />
          <canvas id="draw-canvas" class="absolute top-0 left-0 cursor-crosshair"
        ...
        @if ($belonging->image)
        <button id="save-drawing" class="mt-4 bg-blue-500 text-white px-4 py-2 rounded" data-route="{{ route('belonging-drawing-save', ['id' => $belonging->id]) }}">Save Drawing</button>
